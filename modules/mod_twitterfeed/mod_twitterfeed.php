<?php
/**
* @version		$Id: mod_twitterfeed.php 10396 2008-06-05 19:19:55Z willebil $
* @package		Joomla
...
// if($params->get('twitterfeedtype', 1) == "0")
if(true)
{
...
/**
  ...
  {
  	echo '<div>';
  	echo JText::_('No feed URL specified.' . $params->get('twitterfeedtype', 1));
  	echo '</div>';
  	return;
  }
**/
  ...
  $feed = modTwitterFeedHelper::getFeed($params);
